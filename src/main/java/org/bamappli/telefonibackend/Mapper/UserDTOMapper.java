...
public class UserDTOMapper implements Function<Utilisateur, UtilisateurDTO> {
    ...
    public UtilisateurDTO apply(Utilisateur utilisateur) {
        return new UtilisateurDTO(utilisateur.getId(), utilisateur.getNom(), utilisateur.getEmail(), utilisateur.getAdresse(), utilisateur.getRole().getNom(), utilisateur.getPhotoUrl(), utilisateur.getNumeroDeTelephone());
    }
}
